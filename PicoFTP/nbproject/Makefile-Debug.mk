...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/picoftp.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/picoftp.exe: ${OBJECTFILES}
...
${OBJECTDIR}/lookup.o: lookup.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lookup.o lookup.c
