...
${OBJECTDIR}/lookup.o: lookup.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lookup.o lookup.c
...
${TESTDIR}/tests/c_path.o: tests/c_path.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/c_path.o tests/c_path.c
...
${OBJECTDIR}/client_nomain.o: ${OBJECTDIR}/client.o client.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client_nomain.o client.c;\
	else  \
...
${OBJECTDIR}/ftp_nomain.o: ${OBJECTDIR}/ftp.o ftp.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ftp_nomain.o ftp.c;\
	else  \
...
${OBJECTDIR}/lookup_nomain.o: ${OBJECTDIR}/lookup.o lookup.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lookup_nomain.o lookup.c;\
	else  \
...
${OBJECTDIR}/path_nomain.o: ${OBJECTDIR}/path.o path.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/path_nomain.o path.c;\
	else  \
...
${OBJECTDIR}/server_nomain.o: ${OBJECTDIR}/server.o server.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/server_nomain.o server.c;\
	else  \
...
${OBJECTDIR}/worker_nomain.o: ${OBJECTDIR}/worker.o worker.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/worker_nomain.o worker.c;\
	else  \
